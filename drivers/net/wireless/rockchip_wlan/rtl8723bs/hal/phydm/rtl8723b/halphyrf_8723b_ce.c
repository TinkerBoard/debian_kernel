...
#if (DM_ODM_SUPPORT_TYPE & ODM_AP)
	phy_iq_calibrate_8723b(p_dm_odm, false, false);
#else
...
)
{
	...
	if (method == TXAGC) {
		...
		if (p_dm_odm->mp_mode == true) {
			...
			pwr += p_dm_odm->rf_calibrate_info.power_index_offset[rf_path];
			...
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("ODM_TxPwrTrackSetPwr8723B: CCK Tx-rf(A) Power = 0x%x\n", tx_agc));
			...
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("ODM_TxPwrTrackSetPwr8723B: OFDM Tx-rf(A) Power = 0x%x\n", tx_agc));
		} else {
		...
		set_iqk_matrix_8723b(p_dm_odm, final_ofdm_swing_index, rf_path,
		...
		if (final_ofdm_swing_index > pwr_tracking_limit_ofdm) {	/* BBSwing higher then Limit */
			...
			set_iqk_matrix_8723b(p_dm_odm, pwr_tracking_limit_ofdm, rf_path,
				p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][0],
				p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][1]);
			...
			set_iqk_matrix_8723b(p_dm_odm, 0, rf_path,
				p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][0],
				p_dm_odm->rf_calibrate_info.iqk_matrix_reg_setting[channel_mapped_index].value[0][1]);
...
)
{
	...
	*	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0x43, RFREGOFFSETMASK, 0x40ec1 ); */
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("LO calibration setting!\n")); */
	...
	/* GNT_BT = 0 */
	odm_set_bb_reg(p_dm_odm, 0x764, MASKDWORD, 0x00000800);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path A LOK & IQK.\n", IQK_DELAY_TIME_8723B)); */
	...
	/* GNT_BT = 1 */
	odm_set_bb_reg(p_dm_odm, 0x764, MASKDWORD, 0x00001800);
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path A RX IQK:Get TXIMR setting\n"));
	/* 1 Get TXIMR setting */
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path-A Rx IQK modify RXIQK mode table 2!\n")); */
	...
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0x55, RFREGOFFSETMASK, 0x4021f);
...
)
{
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("LO calibration setting!\n")); */
	...
	/* switch to path B */
	odm_set_bb_reg(p_dm_odm, 0x948, MASKDWORD, 0x00000280);
	/*	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xb0, RFREGOFFSETMASK, 0xeffe0); */
...
)
{
	...
	/* 1 Get TXIMR setting */
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path B RX IQK:Get TXIMR setting!\n"));
	/* modify RXIQK mode table
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("path-A Rx IQK modify RXIQK mode table!\n")); */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_WE_LUT, 0x80000, 0x1);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	...
	/* open PA S1 & SMIXER */
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xed, 0x20, 0x1);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0x43, RFREGOFFSETMASK, 0x60fcd);
	...
	* 	ODM_RT_TRACE(p_dm_odm,ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("delay %d ms for One shot, path A LOK & IQK.\n", IQK_DELAY_TIME_88E)); */
	...
	/*	PA/PAD controlled by 0x0 */
	/* leave IQK mode
	*	odm_set_bb_reg(p_dm_odm, REG_FPGA0_IQK, 0xffffff00, 0x00000000);
...
)
{
	...
	if (final_candidate == 0xFF)
		...
		if (is_tx_only) {
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_path_a_fill_iqk_matrix8723b only Tx OK\n"));
...
)
{
	...
	if (final_candidate == 0xFF)
		...
		p_rf_calibrate_info->tx_iqc_8723b[PATH_S0][idx_0xc94][VAL] = odm_get_bb_reg(p_dm_odm, REG_OFDM_0_XD_TX_AFE, MASKDWORD);
		...
		p_rf_calibrate_info->tx_iqc_8723b[PATH_S0][idx_0xc80][VAL] = odm_get_bb_reg(p_dm_odm, REG_OFDM_0_XB_TX_IQ_IMBALANCE, MASKDWORD);
		...
		if (is_tx_only) {
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_path_b_fill_iqk_matrix8723b only Tx OK\n"));

			p_rf_calibrate_info->rx_iqc_8723b[PATH_S0][idx_0xc14][KEY] = REG_OFDM_0_XA_RX_IQ_IMBALANCE;
			/*			p_rf_calibrate_info->rx_iqc_8723b[PATH_S0][idx_0xc14][VAL] = odm_get_bb_reg(p_dm_odm, REG_OFDM_0_XA_RX_IQ_IMBALANCE, MASKDWORD); */
		...
		p_rf_calibrate_info->rx_iqc_8723b[PATH_S0][idx_0xc14][KEY] = REG_OFDM_0_XA_RX_IQ_IMBALANCE;
		p_rf_calibrate_info->rx_iqc_8723b[PATH_S0][idx_0xc14][VAL] = odm_get_bb_reg(p_dm_odm, REG_OFDM_0_XB_RX_IQ_IMBALANCE, MASKDWORD);

		reg = (result[final_candidate][7] >> 6) & 0xF;
		/*		odm_set_bb_reg(p_dm_odm, REG_OFDM_0_AGC_RSSI_TABLE, 0x0000F000, reg); */
		p_rf_calibrate_info->rx_iqc_8723b[PATH_S0][idx_0xca0][KEY] = REG_OFDM_0_RX_IQ_EXT_ANTA;
		p_rf_calibrate_info->rx_iqc_8723b[PATH_S0][idx_0xca0][VAL] = (reg << 28) | (odm_get_bb_reg(p_dm_odm, REG_OFDM_0_RX_IQ_EXT_ANTA, MASKDWORD) & 0x0fffffff);
	}
}
...
)
{
	...
	if ((p_rf_calibrate_info->tx_iqc_8723b[PATH_S0][idx_0xc80][VAL] != 0x0) && (p_rf_calibrate_info->rx_iqc_8723b[PATH_S0][idx_0xc14][VAL] != 0x0) &&
		...
		if (rf_path) { /* S1: rf_path = 0, S0:rf_path = 1 */
			/* S0 TX IQC */
			odm_set_bb_reg(p_dm_odm, p_rf_calibrate_info->tx_iqc_8723b[PATH_S0][idx_0xc94][KEY], MASKDWORD, p_rf_calibrate_info->tx_iqc_8723b[PATH_S0][idx_0xc94][VAL]);
			...
			odm_set_bb_reg(p_dm_odm, p_rf_calibrate_info->tx_iqc_8723b[PATH_S0][idx_0xc4c][KEY], MASKDWORD, p_rf_calibrate_info->tx_iqc_8723b[PATH_S0][idx_0xc4c][VAL]);
			/* S0 RX IQC */
			...
			/* S1 TX IQC */
			odm_set_bb_reg(p_dm_odm, p_rf_calibrate_info->tx_iqc_8723b[PATH_S1][idx_0xc94][KEY], MASKDWORD, p_rf_calibrate_info->tx_iqc_8723b[PATH_S1][idx_0xc94][VAL]);
			...
			odm_set_bb_reg(p_dm_odm, p_rf_calibrate_info->tx_iqc_8723b[PATH_S1][idx_0xc4c][KEY], MASKDWORD, p_rf_calibrate_info->tx_iqc_8723b[PATH_S1][idx_0xc4c][VAL]);
			/* S1 RX IQC */
	...
	struct _ADAPTER		*adapter)
{
	...
	if (rtw_is_drv_stopped(padapter) || adapter->is_driver_is_going_to_pnp_set_power_sleep || rt_state == e_rf_off) {
...
)
{
	...
	if (p_adapter->registrypriv.mp_mode == 1 && p_adapter->mppriv.mode == 3) {
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("%s() :return !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n", __func__));
		return;
	}
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_save_adda_registers8723b(p_adapter, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);
		_phy_save_mac_registers8723b(p_adapter, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
		_phy_save_adda_registers8723b(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#else
		_phy_save_adda_registers8723b(p_dm_odm, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);
		_phy_save_mac_registers8723b(p_dm_odm, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
		_phy_save_adda_registers8723b(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#endif
	}
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQ Calibration for %s for %d times\n", (is2T ? "2T2R" : "1T1R"), t));
	...
	_phy_path_adda_on8723b(p_adapter, ADDA_REG, true, is2T);
#else
	_phy_path_adda_on8723b(p_dm_odm, ADDA_REG, true, is2T);
#endif
	...
	*	path_sel_rf = odm_get_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xb0, 0xfffff); */
	...
	/* MAC settings */
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
	_phy_mac_setting_calibration8723b(p_adapter, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
#else
	_phy_mac_setting_calibration8723b(p_dm_odm, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);
#endif
...
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		path_aok = phy_path_a_iqk_8723b(p_adapter, is2T, rf_path);
#else
		path_aok = phy_path_a_iqk_8723b(p_dm_odm, is2T, rf_path);
#endif
		/*		if(path_aok == 0x03){ */
		if (path_aok == 0x01) {
	...
	for (i = 0 ; i < retry_count ; i++) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		path_aok = phy_path_a_rx_iqk_8723b(p_adapter, is2T, rf_path);
#else
		path_aok = phy_path_a_rx_iqk_8723b(p_dm_odm, is2T, rf_path);
#endif
		if (path_aok == 0x03) {
	...
	if (is2T) {
		...
		for (i = 0 ; i < retry_count ; i++) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
			path_bok = phy_path_b_rx_iqk_8723b(p_adapter, is2T);
#else
			path_bok = phy_path_b_rx_iqk_8723b(p_dm_odm, is2T);
#endif
			if (path_bok == 0x03) {
	...
	if (t != 0) {
		...
		_phy_reload_adda_registers8723b(p_adapter, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);

		/* Reload MAC parameters */
		_phy_reload_mac_registers8723b(p_adapter, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);

		_phy_reload_adda_registers8723b(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#else
		/* Reload ADDA power saving parameters */
		_phy_reload_adda_registers8723b(p_dm_odm, ADDA_REG, p_dm_odm->rf_calibrate_info.ADDA_backup, IQK_ADDA_REG_NUM);

		/* Reload MAC parameters */
		_phy_reload_mac_registers8723b(p_dm_odm, IQK_MAC_REG, p_dm_odm->rf_calibrate_info.IQK_MAC_backup);

		_phy_reload_adda_registers8723b(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup, IQK_BB_REG_NUM);
#endif
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_iq_calibrate_8723b() <==\n"));
...
phy_iq_calibrate_8723b(
	...
	bool		is_recovery,
	bool	is_restore,
	bool	is_2ant,	/* false:1ant, true:2-ant */
...
)
{
	...
	if (is_restore) {
		...
		for (i = 0; i < 3; ++i) {
			...
			if ((offset == 0) || (i == 1 && data == 0)) {	/* 0xc80, 0xc88 ==> index=1 */
				ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("%s =>path:%s Restore TX IQK result failed\n", __func__, (path == ODM_RF_PATH_A) ? "A" : "B"));
				is_result = FAIL;
				break;
			}
		...
		for (i = 0; i < 2; ++i) {
			...
			if ((offset == 0) || (i == 0 && data == 0)) {	/* 0xc14, 0xc1c ==> index=0 */
				ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("%s =>path:%s  Restore RX IQK result failed\n", __func__, (path == ODM_RF_PATH_A) ? "A" : "B"));
				is_result = FAIL;
				break;
			}
		...
		if (p_dm_odm->rf_calibrate_info.tx_lok[ODM_RF_PATH_A] == 0) {
			ODM_RT_TRACE(p_dm_odm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("%s => Restore path-A tx_lok result failed\n", __func__));
			is_result = FAIL;
		} else {
...
#endif
	{
		ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("phy_iq_calibrate_8723b: Return due to is_recovery!\n"));
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_reload_adda_registers8723b(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, 9);
#else
		_phy_reload_adda_registers8723b(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, 9);
#endif
		goto out;
	}
	...
	/* save default GNT_BT */
	GNT_BT_default = odm_get_bb_reg(p_dm_odm, 0x764, MASKDWORD);
	/* Save RF path
	*	path_sel_bb = odm_get_bb_reg(p_dm_odm, 0x948, MASKDWORD);
	*	path_sel_rf = odm_get_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xb0, 0xfffff); */

	/* set GNT_BT=0, pause BT traffic
	*	odm_set_bb_reg(p_dm_odm, 0x764, BIT(12), 0x0);
	*	odm_set_bb_reg(p_dm_odm, 0x764, BIT(11), 0x1); */
	...
	for (i = 0; i < 3; i++) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
		_phy_iq_calibrate_8723b(p_adapter, result, i, is_2ant, rf_path);
#else
		_phy_iq_calibrate_8723b(p_dm_odm, result, i, is_2ant, rf_path);
#endif
...
#if MP_DRIVER == 1
	if ((p_mpt_ctx->mpt_rf_path == ODM_RF_PATH_A) || (p_dm_odm->mp_mode == false))
#endif
	{
		if (rege94 != 0) {
#if !(DM_ODM_SUPPORT_TYPE & ODM_AP)
...
#else
			_phy_path_a_fill_iqk_matrix8723b(p_dm_odm, is_patha_ok, result, final_candidate, (regea4 == 0));
#endif
		}
	}
	...
	_phy_save_adda_registers8723b(p_adapter, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, 9);
#else
	_phy_save_adda_registers8723b(p_dm_odm, IQK_BB_REG_92C, p_dm_odm->rf_calibrate_info.IQK_BB_backup_recover, IQK_BB_REG_NUM);
#endif

	/* restore GNT_BT */
	odm_set_bb_reg(p_dm_odm, 0x764, MASKDWORD, GNT_BT_default);
	/* Restore RF path
	*	odm_set_bb_reg(p_dm_odm, 0x948, MASKDWORD, path_sel_bb);
	*	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xb0, 0xfffff, path_sel_rf); */
	...
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_WE_LUT, 0x80000, 0x1);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_RCK_OS, RFREGOFFSETMASK, 0x18000);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G1, RFREGOFFSETMASK, 0x0001f);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, RF_TXPA_G2, RFREGOFFSETMASK, 0xe6177);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0xed, 0x20, 0x1);
	odm_set_rf_reg(p_dm_odm, ODM_RF_PATH_A, 0x43, RFREGOFFSETMASK, 0x300bd);

	/* set GNT_BT= HW control
	*	odm_set_bb_reg(p_dm_odm, 0x764, BIT(12), 0x0);
	*	odm_set_bb_reg(p_dm_odm, 0x764, BIT(11), 0x0); */
