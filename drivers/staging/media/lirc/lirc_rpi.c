...
#define DEFAULT_GPIO_IN_PIN 14 //18
#define DEFAULT_GPIO_OUT_PIN 12 //17
...
static int gpio_in_pull = 0; //BCM2708_PULL_DOWN;
...
static int init_port(void)
{
	...
	gpiochip = gpiochip_find("gpio5", is_right_chip);
...
static int set_use_inc(void *data)
{
	...
	result = request_any_context_irq(irq_num,
