...
#define ov8858_AEC_PK_LONG_GAIN_HIGH_REG 0x3508	/* Gain Bits 8-10 */
#define ov8858_AEC_PK_LONG_GAIN_LOW_REG	 0x3509	/* Gain Bits 0 -7 */
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4826, 0x40},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4808, 0x25},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x030e, 0x00}, // pll2_rdiv						 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x030f, 0x09}, // pll2_divsp						 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0312, 0x01}, // pll2_pre_div0, pll2_r_divdac 	 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3015, 0x01}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3501, 0x4d}, // exposure M						 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3502, 0x40}, // exposure L						 
//{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3508, 0x04}, // gain H							 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3706, 0x35}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x370a, 0x00}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x370b, 0xb5}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3778, 0x1b}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3808, 0x06}, // x output size H					 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3809, 0x60}, // x output size L					 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380a, 0x04}, // y output size H					 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380b, 0xc8}, // y output size L					 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380c, 0x07}, // HTS H							 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380d, 0x88}, // HTS L							 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380e, 0x04}, // VTS H							 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380f, 0xdc}, // VTS L							 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3814, 0x03}, // x odd inc						 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3821, 0x67}, // mirror on, bin on				 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382a, 0x03}, // y odd inc						 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3830, 0x08}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3836, 0x02}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3f0a, 0x80}, //									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4001, 0x10}, // total 128 black column			 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4022, 0x04}, // Anchor left end H				 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4023, 0xb9}, // Anchor left end L				 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4024, 0x05}, // Anchor right start H 			 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4025, 0x2a}, // Anchor right start L 			 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4026, 0x05}, // Anchor right end H				 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4027, 0x2b}, // Anchor right end L				 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x402b, 0x04}, // top black line number			 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x402e, 0x08}, // bottom black line start			 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4500, 0x38}, 									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4600, 0x00}, 									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4601, 0xcb}, 									 
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382d, 0x7f}
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4826, 0x40},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4808, 0x25},
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x030e, 0x02}, // pll2_rdiv					
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x030f, 0x04}, // pll2_divsp					
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x0312, 0x03}, // pll2_pre_div0, pll2_r_divdac 
...
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3808, 0x0c}, // x output size H				
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3809, 0xc0}, // x output size L				
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380a, 0x09}, // y output size H				
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380b, 0x90}, // y output size L				
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380c, 0x07}, // HTS H						
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380d, 0x94}, // HTS L						
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380e, 0x09}, // VTS H						
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x380f, 0xaa}, // VTS L						
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3814, 0x01}, // x odd inc					
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3821, 0x46}, // mirror on, bin off			
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382a, 0x01}, // y odd inc					
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3830, 0x06}, //								
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3836, 0x01}, //								
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x3f0a, 0x00}, //								
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4001, 0x00}, // total 256 black column		
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4022, 0x0b}, // Anchor left end H			
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4023, 0xc3}, // Anchor left end L			
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4024, 0x0c}, // Anchor right start H 		
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4025, 0x36}, // Anchor right start L 		
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4026, 0x0c}, // Anchor right end H			
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4027, 0x37}, // Anchor right end L			
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x402b, 0x08}, // top black line number		
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x402e, 0x0c}, // bottom black line start		
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4500, 0x58}, 								
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4600, 0x01}, 								
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x4601, 0x97}, 								
{OV_CAMERA_MODULE_REG_TYPE_DATA, 0x382d, 0xff}
