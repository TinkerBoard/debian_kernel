...
static struct i2c_board_info __initdata i2c_devices_rpi_ts_mcu[] = {
      {
               I2C_BOARD_INFO("rpi_ts_mcu", 0x45),
      },
};
...
static void __init rockchip_dt_init(void)
{
	...
	i2c_register_board_info(3, i2c_devices_rpi_ts_mcu, ARRAY_SIZE(i2c_devices_rpi_ts_mcu));
}
